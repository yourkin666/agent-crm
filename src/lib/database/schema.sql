...
CREATE TABLE IF NOT EXISTS customers (
  ...
  community TEXT NOT NULL,               -- 咨询小区
  business_type TEXT NOT NULL,           -- 业务类型 (whole_rent=整租, centralized=集中, shared_rent=合租)
  room_type TEXT NOT NULL,               -- 居室 (one_bedroom, two_bedroom, three_bedroom, four_plus, master_room, second_room)
